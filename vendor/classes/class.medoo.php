...
class Medoo
{
	...
	/* Error protected $prefix; */

	protected $option = array();

	// Variable
	/* Error protected $logs = array(); */
	...
	protected function column_push($columns)
	{
		...
		foreach ($columns as $key => $value)
		{
			...
			{
				array_push($stack, $this->column_quote( $value )); /* Error array_push($stack, $this->column_quote( $value )); */
			}
		}

		 /* Error return implode($stack, ','); */
	}
	...
	protected function select_context($table, $join, &$columns = null, $where = null, $column_fn = null)
	{
		...
		{
			$column = $this->column_push($columns); /* Error $column = $this->column_push($columns); */
		}
